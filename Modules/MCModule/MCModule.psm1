...
function Get-MCServerDetails {
    ...
    $obj | Add-Member -MemberType NoteProperty -Name "Players" -Value "$($Query.Players.Online)"
    $obj | Add-Member -MemberType NoteProperty -name "MaxPlayers" -Value "$($Query.Players.Max)"
