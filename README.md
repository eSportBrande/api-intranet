...
6.  Add it to the `.env` file as `pterodactylApikey`

`CORS_ALLOWED_ORIGINS` is a comma-separated list of allowed origins. For example: `["https://url1.com", "https://url2.com"]`